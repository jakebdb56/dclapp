...
const KNOWN_PORTS = [
  ...
  ["St. John's, Newfoundland", 47.5615, -52.7126, ["st john s newfoundland", "saint john s newfoundland"]],
...
const KNOWN_PORT_DETAIL_URLS = new Map(
  [
    ["Astoria, Oregon", "/ports/astoria-oregon/"],
    ["Auckland, New Zealand", "/ports/auckland-new-zealand/"],
    ["Barcelona, Spain", "/ports/barcelona-spain/"],
    ["Basseterre, St. Kitts", "/ports/basseterre-st-kitts/"],
    ["Bridgetown, Barbados", "/ports/bridgetown-barbados/"],
    ["Brisbane, Australia", "/ports/brisbane-australia/"],
    ["Cabo San Lucas, Mexico", "/ports/cabo-san-lucas-mexico/"],
    ["Cartagena, Colombia", "/ports/cartagena-colombia/"],
    ["Castaway Cay, Bahamas", "/ports/castaway-cay/"],
    ["Charlottetown, Prince Edward Island", "/ports/charlottetown-prince-edward-island/"],
    ["Christchurch, New Zealand", "/ports/christchurch-new-zealand/"],
    ["Costa Maya, Mexico", "/ports/costa-maya-mexico/"],
    ["Cozumel, Mexico", "/ports/cozumel-mexico/"],
    ["Disney Lookout Cay at Lighthouse Point, Bahamas", "/ports/lighthouse-point/"],
    ["Dover, England", "/ports/dover-england/"],
    ["Eden, Australia", "/ports/eden-australia/"],
    ["Ensenada, Mexico", "/ports/ensenada-mexico/"],
    ["Falmouth, Jamaica", "/ports/falmouth-jamaica/"],
    ["Fiordland National Park, New Zealand", "/ports/fiordland-national-park-new-zealand/"],
    ["Fort Lauderdale, Florida", "/ports/fort-lauderdale-florida/"],
    ["Galveston, Texas", "/ports/galveston-texas/"],
    ["George Town, Grand Cayman", "/ports/grand-cayman-cayman-islands/"],
    ["Halifax, Nova Scotia", "/ports/halifax-nova-scotia/"],
    ["Hobart, Tasmania, Australia", "/ports/hobart-australia/"],
    ["Honolulu, Hawaii", "/ports/honolulu-oahu/"],
    ["Icy Strait Point, Alaska", "/ports/icy-strait-point-alaska/"],
    ["Juneau, Alaska", "/ports/juneau-alaska/"],
    ["Kahului, Maui, Hawaii", "/ports/kahului-hawaii/"],
    ["Ketchikan, Alaska", "/ports/ward-cove-alaska/"],
    ["Kralendijk, Bonaire", "/ports/kralendijk-bonaire/"],
    ["Lautoka, Fiji", "/ports/lautoka-fiji/"],
    ["Lisbon, Portugal", "/ports/lisbon-portugal/"],
    ["Melbourne, Australia", "/ports/melbourne-australia/"],
    ["Napier, New Zealand", "/ports/napier-new-zealand/"],
    ["Nassau, Bahamas", "/ports/nassau/"],
    ["New Plymouth, New Zealand", "/ports/new-plymouth-new-zealand/"],
    ["New York, New York", "/ports/new-york/"],
    ["Noumea, New Caledonia", "/ports/noumea-new-caledonia/"],
    ["Pago Pago, American Samoa", "/ports/pago-pago-american-samoa/"],
    ["Philipsburg, St. Maarten", "/ports/st-maarten/"],
    ["Port Canaveral, Florida", "/ports/port-canaveral-florida/"],
    ["Progreso, Mexico", "/ports/progreso-mexico/"],
    ["Road Town, Tortola", "/ports/tortola-british-virgin-islands/"],
    ["San Diego, California", "/ports/san-diego-california/"],
    ["San Francisco, California", "/ports/san-francisco-california/"],
    ["San Juan, Puerto Rico", "/ports/san-juan-puerto-rico/"],
    ["Seattle, Washington", "/ports/seattle-washington/"],
    ["Sitka, Alaska", "/ports/sitka-alaska/"],
    ["Skagway, Alaska", "/ports/skagway-alaska/"],
    ["St. John's, Antigua", "/ports/st-johns-antigua/"],
    ["St. John's, Newfoundland", "/ports/saint-johns-newfoundland/"],
    ["St. Thomas, U.S. Virgin Islands", "/ports/st-thomas-st-john-us-virgin-islands/"],
    ["Suva, Fiji", "/ports/suva-fiji/"],
    ["Sydney, Australia", "/ports/sydney-australia/"],
    ["Sydney, Nova Scotia", "/ports/sydney-nova-scotia/"],
    ["Tauranga, New Zealand", "/ports/tauranga-new-zealand/"],
    ["Vancouver, British Columbia", "/ports/vancouver-british-columbia-canada/"],
    ["Victoria, British Columbia", "/ports/victoria-british-columbia-canada/"],
    ["Wellington, New Zealand", "/ports/wellington-new-zealand/"]
  ].map(([name, path]) => [normalizePortName(name), absolutePortUrl(path)])
);
...
function urlAwareCoordinateForPort(url) {
  ...
  if (slug === "sydney nova scotia") {
    return KNOWN_PORTS_BY_ALIAS.get("sydney nova scotia");
  }

  if (slug === "saint johns newfoundland") {
